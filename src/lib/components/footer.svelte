	...
	<div class="container py-8 lg:py-16 lg:flex lg:justify-between lg:items-center">
		...
		<div class="flex flex-col lg:items-center lg:flex-1">
			<div class="flex items-center gap-2">
				<img
					src={logo}
					alt="Logo Gruyère Padel Club"
					class="w-20 relative -left-2 top-2 lg:hidden"
				/>
				<h3 class="my-0 lg:text-4xl">Gruyère Padel Club</h3>
			</div>
			<div class="mb-8 mt-4 w-72 border-b border-solid border-b-white"></div>
			<div class="mb-12 grid w-full max-w-[208px] grid-flow-col grid-cols-3 gap-3">
				<a
					href={instagramlink}
					target="_blank"
					class="border p-4 rounded-full mx-auto flex flex-col justify-center"
				>
					<img src={instagram} alt="instagram" class="inline-block" />
				</a>
				<a href={whatsapplink} class="border p-4 rounded-full mx-auto flex flex-col justify-center">
		...
		<div class="hidden lg:block lg:flex-1 lg:flex lg:justify-end">
